...
trait ResponseTrait
{
    ...
    public function respondWithSuccessCreate(ResourceCollection|JsonResource $resource, string $message = 'success'): JsonResponse
    {
    ...
    public function respondWithMessage (string $message, int $code = 200): JsonResponse {
